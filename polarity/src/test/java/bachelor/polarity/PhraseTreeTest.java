...
import de.tudarmstadt.ukp.dkpro.core.dictionaryannotator.PhraseTreeElement;

/**
 * Stores phrases in a tree structure to allow efficient access. Used by the
 * DictionaryAnnotator.
 * 
 */
public class PhraseTreeTest {
	...
	public void addPhrase(String[] phraseParts) {
		...
		for (String phrasePart : phraseParts) {
			...
			current = child;
//			System.out.println("phrasePart: " + phrasePart);
		}
	...
	/**
	 * Returns the longest matching phrase in the tree, beginning with the first
	 * array entry in matchText.
	 * 
	 * @param matchText
