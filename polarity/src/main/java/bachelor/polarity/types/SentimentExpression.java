 ...
 * @generated */
public class SentimentExpression extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(SentimentExpression.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected SentimentExpression() {/* intentionally empty block */}
   ...
   */
  public SentimentExpression(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public SentimentExpression(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public SentimentExpression(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
