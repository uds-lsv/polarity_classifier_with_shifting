 ...
 *
 *         An instance of the class DependencyGraph represents an instance of
 *         the dependency graph structure of a sentence. All dependency graphs
 *         have a WordObj root as their uppermost node. Then they consist of a
 *         HashSet in which all the graph's edges are stored (existing
 *         dependency relations between WordObj). Also, all the nodes of the
 *         graph are stored in a separate HashSet.
 *
 */
public class DependencyGraph {

	private WordObj root;
	 ...
	 * @param depRel
	 *          the dependency relation of this edge
	 ...
	 *
	 * @param word
	 *          A string which is supposed to be equivalent to a node in the graph
	 ...
	 *
	 * @param sentiment
	 *          The sentiment expression the graph contains (WordObj is entry in
	 ...
	 *          graph of the sentence has been deleted due to normalization, the
	 ...
	 *
	 * @param word
	 *          The WordObj of the auxillary verb or predicative expression
	 *          respectively
	 * @param graph
	 *          The graph object of the sentence
	 ...
	 *
	 * @param word
	 *          the WordObj in the graph from which the prepositional phrase's
	 *          edges leave
	 * @param graph
	 *          the sentence's graph object
	 * @param depRel
	 *          specify if the prepositional phrase is either introduced by a pp-
	 *          oder an objp-relation
	 ...
	 *
	 * @param graph
	 *          Used to find 'obja' relation.
	 * @param parent
	 *          Word object considered to be conjunction parent.
	 * @param child
	 *          Word object considered to be conjunction child.
	 */
	 ...
	 *
	 * @param graph
	 *          Dependency graph used to extract relational information.
	 * @param word
	 *          Current word object in the word list.
	 * @param prevComma
	 *          Was the last word object in the word list a comma?
	 */
	private void normalizeConjunction(DependencyGraph graph, WordObj word, boolean prevComma) {
		...
		// are parent and child either "ADJD", "VVFIN" or "VVPP"
	 ...
	 *
	 * @param startNode
	 *          the node from which the chain search starts.
	 * @param mweWordsToBeMatched
	 *          is the list of strings/words that are to be found/matched in the
	 *          graph/tree.
	 * @param topCall
	 *          indicates if it is the top call of the recursive function or not.
	 ...
	 *
	 * @param wtmp
	 *          The word from which the MWE sentiment expression is recognized.
	 * @param mwe
	 ...
	 *
	 * @param wtmp
	 *          The word from which the MWE could be evoked (lexicon entry).
	 * @param mwe
	 *          The MWE that is checked.
	 ...
	 *
	 * @param matches
	 *          is the ArrayList from which duplicates are removed
	 * @param minLength
	 *          is the length that the matches should have at least. (So if there
	 *          are still duplicates, but the minLength is reached nothing is
	 *          removed)
	 * @return ArrayList
	 */
	 ...
	 *
	 * @param matches
	 *          is the ArrayList in which two duplicates are searched for.
